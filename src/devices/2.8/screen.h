...
void xtouch_screen_updateBackLed()
{
    const uint8_t stateColors[][7] = {
        {0x00,0x00,0x00,0x00,0x00,0x00,0x00},   // XTOUCH_PRINT_STATUS_IDLE         off
        {0xFF,0xFF,0x00,0xFF,0xFF,0x00,0x01},   // XTOUCH_PRINT_STATUS_RUNNING      yellow/green
        {0x88,0x00,0xFF,0xFF,0xFF,0x00,0x04},   // XTOUCH_PRINT_STATUS_PAUSED       magenta/yellow
        {0x00,0x7F,0x00,0x00,0x7F,0x00,0x00},   // XTOUCH_PRINT_STATUS_FINISHED     green
        {0xFF,0xFF,0x88,0x00,0x00,0x00,0x01},   // XTOUCH_PRINT_STATUS_PREPARE      yellow/off
        {0x00,0x00,0x00,0xFF,0x00,0x00,0x03}    // XTOUCH_PRINT_STATUS_FAILED       red/off
    };
